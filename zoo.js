...
// Assign clue to random animal - HELPPPPPPP
function getClue() {
...
// Explore each habitat & creatures within
function exploreHabitat(habitats) {
    visitorLocation = habitats.name.description
    console.log('You have entered the', habitats)
    console.log(habitats.description)
}
